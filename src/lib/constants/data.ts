...
export const contactSections = [
  ...
  },
  {
    ...
    title: "Social",
    items: [
      { text: "Instagram", isLink: true, href: "https://instagram.com" },
      { text: "LinkedIn", isLink: true, href: "https://linkedin.com" },
      { text: "Dribbble", isLink: true, href: "https://dribbble.com" },
      { text: "Behance", isLink: true, href: "https://behance.net" },
    ],
  },
];
